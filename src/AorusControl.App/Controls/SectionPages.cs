...
/// all (all six sections live in one ContentOverlay, toggled by
...
/// NavigationView keys its navigation on the page type, so several items sharing one type
...
internal sealed class GraphicsPage : Page;
