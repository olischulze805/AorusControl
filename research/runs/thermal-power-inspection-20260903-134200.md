...
- Created: 2026-09-03 13:41:51 -03:00
- Mode: read-only
...
- GPU state: exit `0`
```text
NVIDIA GeForce RTX 3070 Laptop GPU, P5, 16.69 W, Disabled, [Requested functionality has been deprecated], 49, [N/A]
```
...
- `getCpuTemp` (in [], out [Data:UInt16]): Data=59
- `getGpuTemp1` (in [], out [Data:UInt16]): Data=49
- `getGpuTemp2` (in [], out [Data:UInt16]): Data=0
- `getRpm1` (in [], out [Data:UInt16]): Data=64777
- `getRpm2` (in [], out [Data:UInt16]): Data=35338
- `GetCPUFanDuty` (in [], out [Data:UInt8]): Data=93
- `GetGPUFanDuty` (in [], out [Data:UInt8]): Data=93
...
- `GetPEGorSG` (in [], out [Data:UInt8]): Data=93
...
- Sample 1 at 13:41:52: CPU 59 °C, GPU 49 °C, CPU fan raw 64777 / 2557 RPM, GPU fan raw 35338 / 2698 RPM, CPU duty raw 93, GPU duty raw 93
- Sample 2 at 13:41:54: CPU 51 °C, GPU 48 °C, CPU fan raw 3338 / 2573 RPM, GPU fan raw 34570 / 2695 RPM, CPU duty raw 93, GPU duty raw 93
- Sample 3 at 13:41:56: CPU 51 °C, GPU 48 °C, CPU fan raw 28169 / 2414 RPM, GPU fan raw 61705 / 2545 RPM, CPU duty raw 84, GPU duty raw 84
