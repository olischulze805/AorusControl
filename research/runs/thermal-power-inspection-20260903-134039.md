...
- Created: 2026-09-03 13:40:34 -03:00
- Mode: read-only
...
- GPU state: exit `0`
```text
NVIDIA GeForce RTX 3070 Laptop GPU, P5, 16.53 W, Disabled, [Requested functionality has been deprecated], 48, [N/A]
```
...
- `getCpuTemp` (in [], out [Data:UInt16]): Data=56
- `getGpuTemp1` (in [], out [Data:UInt16]): Data=47
- `getGpuTemp2` (in [], out [Data:UInt16]): Data=0
- `getRpm1` (in [], out [Data:UInt16]): Data=22023
- `getRpm2` (in [], out [Data:UInt16]): Data=51719
