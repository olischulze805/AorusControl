...
- Created: 2026-09-03 12:49:22 -03:00
...
|---|---|---|---|
| `0 (gemessen)` | `0` | `0` | Alles bleibt aus |
| `0 (gemessen)` | `25` | `25` | Alles bleibt aus |
| `0 (gemessen)` | `50` | `50` | Jetzt ist sie an gegangen auf weiss, hellstste stuffe also 3 |
| `24 (gemessen)` | `0` | `0` | Ist aus gegangen |
| `24 (gemessen)` | `25` | `25` | bleibt aus |
| `24 (gemessen)` | `50` | `50` | Ist an gegangen voll auf stuffe 3 |
| `32 (gemessen)` | `0` | `0` | Aus |
| `32 (gemessen)` | `25` | `25` | Aus |
| `32 (gemessen)` | `50` | `50` | Voll stuffe 3 |
| `50 (gemessen)` | `0` | `0` | Aus |
| `50 (gemessen)` | `25` | `25` | Aus |
| `50 (gemessen)` | `50` | `50` | Voll stuffe 3 |
