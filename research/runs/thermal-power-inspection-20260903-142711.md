...
- Created: 2026-09-03 14:27:01 -03:00
- Mode: read-only
...
- GPU state: exit `0`
```text
NVIDIA GeForce RTX 3070 Laptop GPU, P8, 20.43 W, Disabled, [Requested functionality has been deprecated], 47, [N/A]
```
...
25156, C:\Program Files\WindowsApps\Microsoft.WindowsTerminal_1.24.11911.0_x64__8wekyb3d8bbwe\WindowsTerminal.exe, [N/A]
```

## Firmware getter state

- Live instance: `\\AORUS5\root\WMI:GB_WMIACPI_Get.InstanceName="ACPI\\PNP0C14\\DCK_0"`
- `getCpuTemp` (in [], out [Data:UInt16]): Data=49
- `getGpuTemp1` (in [], out [Data:UInt16]): Data=46
- `getGpuTemp2` (in [], out [Data:UInt16]): Data=0
- `getRpm1` (in [], out [Data:UInt16]): Data=24583
...
- Sample 1 at 14:27:03: CPU 49 °C, GPU 46 °C, CPU fan raw 24583 / 1888 RPM, GPU fan raw 54535 / 2005 RPM, CPU duty raw 66, GPU duty raw 66
- Sample 2 at 14:27:05: CPU 49 °C, GPU 46 °C, CPU fan raw 22023 / 1878 RPM, GPU fan raw 52743 / 1998 RPM, CPU duty raw 66, GPU duty raw 66
- Sample 3 at 14:27:07: CPU 51 °C, GPU 46 °C, CPU fan raw 25863 / 1893 RPM, GPU fan raw 56071 / 2011 RPM, CPU duty raw 66, GPU duty raw 66
